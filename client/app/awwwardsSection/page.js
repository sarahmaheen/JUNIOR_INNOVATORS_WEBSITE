...
const awards = [
  { id: 1, image: "https://i.pinimg.com/474x/9d/2c/0e/9d2c0e038204020b707d3b42aa72c175.jpg", title: "🏆 جائزة التميز", description: "هذه الجائزة مُنحت للأداء المتميز." },
  { id: 2, title: "🎨 أفضل تصميم", description: "تم اختيار هذا التصميم كأفضل تصميم لهذا العام." },
  { id: 3, image: "./images/image14.jpg" },
  ...
  { id: 8, image: "https://i.pinimg.com/236x/64/7f/69/647f69f21dee7b1e17a3a68844b793f8.jpg", title: "💻 أفضل موقع إلكتروني", description: "موقع إلكتروني حاز على إعجاب الحكام." },
  { id: 9, image: "./images/image11.jpg", description: "إنجاز رائع في عالم التقنية." },
  ...
  { id: 12, image: "https://i.pinimg.com/474x/dd/67/8a/dd678ae8589c58806748586c454f7233.jpg" },
];
...
export default function AwwwardsSection() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-10">
      <h2 className="text-6xl font-bold text-center mb-6 text-[rgb(var(--teal-blue))]">🏆 الجوائز والتكريمات</h2>
